...
2- Enter your email: <b>{{$details['evaluator_email']}}</b> <br>
3- Enter your password: <b>{{$details['evaluator_password']}}</b> <br>
4- That's your dashboard. Go to <b>{{$details['competition_name']}}</b> <br>
